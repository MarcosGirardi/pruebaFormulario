	...
	<body>
		...
		<div id="show-pruebaformulario" class="content scaffold-show" role="main">
			...
			<ol class="property-list pruebaformulario">
				...
				<g:if test="${pruebaformularioInstance?.apellido}">
				<li class="fieldcontain">
					<span id="apellido-label" class="property-label"><g:message code="pruebaformulario.apellido.label" default="Apellido" /></span>
					
						<span class="property-value" aria-labelledby="apellido-label"><g:fieldValue bean="${pruebaformularioInstance}" field="apellido"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${pruebaformularioInstance?.fechaNac}">
				<li class="fieldcontain">
					<span id="fechaNac-label" class="property-label"><g:message code="pruebaformulario.fechaNac.label" default="Fecha Nac" /></span>
					
						<span class="property-value" aria-labelledby="fechaNac-label"><g:formatDate date="${pruebaformularioInstance?.fechaNac}" /></span>
